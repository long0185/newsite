		...
		element: <div className="w-100 h-100 flex flex-col pt-10">
			<div className="w-100 flex flex-col items-start justify-start p-10">
				...
				<div className="flex justify-center items-center mt-3">
					...
					<span className="font_size_18 font-$color">{item.salary}k</span>
				</div>
				<div className="flex justify-center items-center mt-3">
					<span className="font_size_18 font-black mr-5">工作年限:</span>
					<span className="font_size_18 font-$color">{item.rang}年</span>
				</div>
				<div className="flex justify-center items-center mt-3">
					<span className="font_size_18 font-black mr-5">招聘人数:</span>
					<span className="font_size_18 font-$color">{item.num}</span>
				</div>
				<div className="flex justify-center items-center mt-3">
					<span className="font_size_18 font-black mr-5">工作地点</span>
					<span className="font_size_18 font-$color">{item.area}</span>
				</div>
				<div className="flex justify-center items-center mt-3">
					<span className="font_size_18 font-black">岗位职责:</span>
				</div>
				<div className="flex justify-center items-start flex-col mt-3 font_size_18">
				...
				<div className="flex justify-center items-center mt-3">
					<span className="font_size_18 font-black">技能要求:</span>
				</div>
				<div className="flex justify-center items-start flex-col mt-3 font_size_18">
