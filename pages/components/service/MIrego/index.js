    ...
    <div className={`w-100 d-center flex-col mt_63`}>
      <div className={`${s.warp} w-screen flex overflow-hidden relative`}> 
        <motion.div
          ...
          <MGuideItem handleShow={handleShow} img_src="/assets/2560/service/useguide/irego.png" title={'iReGo操作指南 康复计划制定1'} />
          <MGuideItem handleShow={handleShow} img_src="/assets/2560/service/useguide/irego.png" title={'iReGo操作指南 康复计划制定2'} />
          <MGuideItem handleShow={handleShow} img_src="/assets/2560/service/useguide/irego.png" title={'iReGo操作指南 康复计划制定3'} />
        </motion.div>
      </div>
