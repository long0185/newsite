    ...
    <div className={`col-12 p-0 ${s.wrap} d-center flex-col`} id="unit">
      ...
      <div className="flex">
        <img
          ...
          className={`${s.img} border img-fluid relative hover:bg-white hover:scale-105 hover:z-50`}
        ></img>
        <img
          src="/assets/2560/company/unit/2.png"
          className={`${s.img} border-y  img-fluid relative hover:bg-white hover:scale-105 hover:z-50`}
        ></img>
        <img
      ...
      <div className="flex">
        <img
          ...
          className={`${s.img} img-fluid border-x relative hover:bg-white hover:scale-105 hover:z-50`}
        ></img>
        <img
          src="/assets/2560/company/unit/8.png"
          className={`${s.img} img-fluid  relative hover:bg-white hover:scale-105 hover:z-50`}
        ></img>
        <img
