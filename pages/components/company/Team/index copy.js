  ...
  return (
    <div className={`${s.expert_img_wrap} flex items-center `}>
      ...
      <div className="flex flex-col ml-3 self-start">
        ...
        <span className="font_18 text-$37">{item.Title}</span>
        {item.Content.split("\n").map((ele, index) => (
...
const managerList = [
  {
    ...
    name: "李育文",
    title: "CEO / 博士、东方学者",
    desc: ["加拿大麦吉尔大学MCGILL 博士", "加拿大普惠公司等8年项目研发和管理经验"],
  },
  {
    id: 1,
    ...
    name: "王志勇",
    title: "副总经理 / 硕士",
    desc: ["原上海发那科机电有限公司华东区大客户经理", "10年机器人控制应用经验"],
  },
  {
    id: 2,
...
const MMangerCard = ({ img_src = "", name = "", title = "", desc = [] }) => {
  return (
    <div className={`${s.m_teamer} flex flex-col justify-around items-center mb_43 mx-3`}>
    ...
    <div id="team" className="d-center flex-col">
        ...
        <div className="w_2100 flex overflow-hidden">
          ...
          >
            <div className="flex flex-column mobile:flex-row w_2100  justify-between px-4">
              ...
              <TeamCard img_src="/assets/2560/company/hxy.png" name="华续赟" badge="医学专家" title="副教授 / 副主任医师、硕导" desc={["上海中医药大学附属岳阳医院骨伤研究所PI", "中医智能康复教育部工程研究中心青年PI", "中国康复医学会脑功能检测与调控专委会全国委员&青年工作组副组长"]} /> */}
            </div>
      ...
      <div className={`${s.m_expert} mobile:hidden flex items-center justify-center`}>
        <div className="w-100 flex overflow-hidden">
          ...
          >
            <div>
              <div className={`mobile:hidden ${s.m_ceo} flex items-center justify-around mb_43`}>
                <img src="/assets/2560/company/gs.png" className={`${s.expert_m_img} relative`}></img>
                <div className="flex flex-col items-start self-start flex-1 ml-3 px-3 h-100 ">
                  ...
                  <span className="font_30 text-$37 mb-1">专家顾问 / 教授、博导</span>
                  <span className="m-span-point relative font_size_24 text-$86 pl-3">上海大学机电工程与自动化学院PI</span>
                  <span className="m-span-point relative font_size_24 text-$86 pl-3">上海机器人研究所副所长</span>
                  <span className="m-span-point relative font_size_24 text-$86 pl-3">中国康复技术转化与产业促进专业委员会</span>
                </div>
              </div>
              <div className={`mobile:hidden ${s.m_ceo} flex items-center justify-around mb_43`}>
                <img src="/assets/2560/company/qianlaoshi.png" className={`${s.expert_m_img} relative`}></img>
                <div className="flex flex-col flex-1 items-start px-3 ml-3 h-100 ">
                  ...
                  <span className="font_size_30 text-$37 mb-1">专家顾问 / 设计总监、文化学者、艺术家</span>
                  <span className="m-span-point relative font_size_24 text-$86 pl-3">韩国文化部高级访问学者</span>
                  <span className="m-span-point relative font_size_24 text-$86 pl-3">韩国卡露文化高级艺术顾问</span>
              ...
              <div className={`mobile:hidden ${s.m_ceo} flex items-center justify-around mb_43`}>
                <img src="/assets/2560/company/hxy.png" className={`${s.expert_m_img} relative`}></img>
                <div className="flex flex-col flex-1 items-start px-3 ml-3 h-100 ">
                  <div className="flex items-center">
                    <span className="font_30 font-black mb-1">华续赟</span>
                    <span className="ml-3 px-3 py-1 bg-$primary text-white">医学专家</span>
                  </div>
                  <span className="font_size_30 text-$37 mb-1">副教授 / 副主任医师、硕导</span>
                  <span className="m-span-point relative font_size_24 text-$86 pl-3">上海中医药大学附属岳阳医院骨伤研究所PI</span>
                  <span className="m-span-point relative font_size_24 text-$86 pl-3">中医智能康复教育部工程研究中心青年PI</span>
                  <span className="m-span-point relative font_size_24 text-$86 pl-3">中国康复医学会脑功能检测与调控专委会全国委员</span>
                </div>
              </div>
            </div>
          </motion.div>
