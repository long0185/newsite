...
const MangerCard = ({ img_src = "", name = "", title = "", desc = [] }) => {
  return (
    <>
      <div
        className={`${s.m_teamer} mobile:hidden flex flex-col justify-around items-center mb_43 mx-3`}
      >
        <img src={img_src} className={`${s.m_img} relative`}></img>
        <div className="flex flex-col items-start pt-6 w_400 px-3 py-3 h-100 ">
          ...
          >
            ...
            >
              ...
              <div className="flex flex-col items-start w_561 px-3 py-3 pt-6 h-100 ">
                ...
                <span className="ml-3 px-3 py-1 bg-$primary text-white">工学专家</span>
                </div>
                <span className="font_20 text-$37 mb-1">
                专家顾问 / 教授、博导
                </span>
                <span className="span-point relative font_16 text-$86 pl-3">
                上海大学机电工程与自动化学院PI
                </span>
                <span className="span-point relative font_16 text-$86 pl-3">
                上海机器人研究所副所长
