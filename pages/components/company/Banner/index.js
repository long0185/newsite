...
export default function index() {
  ...
  return (
    <>
      <div
        id="about"
        className={`${s.banner} hidden mobile:flex flex-col items-center justify-center relative`}
      >
        <img
        ...
        <div className="fixed  top-52 z-10 left-10 flex flex-col">
          {list.map((item, index) => (
            <a
              ...
              } my-2 px-2 flex items-center text-$primary  hover:bg-$primary hover:text-white `}
              href={item.href}
              key={index}
            >
              <span className={``}>●</span>
              <span className={`${item.active ? "block" : "hidden"} px-2 py-1`}>
                {item.name}
              </span>
            </a>
          ))}
      ...
      <div
        id="about"
        className={`${s.m_banner}  mobile:hidden flex flex-col items-center relative`}
      >
        <img
          src="/assets/2560/company/sec.png"
      ...
      <div className={`w-100 flex flex-col mobile:flex-row justify-between`}>
        ...
        <img
          src="/assets/2560/company/p_1.png"
          className={`${s.m_top_img} mobile:hidden relative`}
        ></img>
        <div className={`${s.m_img_wrap} mobile:hidden flex overflow-hidden`}>
          <div className={`flex flex-col flex-1`}>
            ...
            <div className={`${s.m_center_bottom} flex-1  bg-gray-400 relative`}>
              ...
              >
                ...
                <span className={`${s.big_title} font_size_24 text-white`}>
                  科技重塑人生
                </span>
              </div>
            </div>
          ...
          <div className="flex flex-col flex-1 h-100">
            <div className={`${s.m_right_top_img} flex-1 relative`}>
              <img
                src="/assets/mobile/company/desc/p2.png"
                className={`w-100 h-100`}
              ></img>
              <div className={`${s.m_right_desc} absolute z-20 flex flex-col`}>
                ...
                <span className="font_24">
                  金矢机器人致力于用先进的康复理念+智能化的
                </span>
                <span className="font_24">
                  康复机器人产品助力用户回归家庭、回归社会。
                </span>
              </div>
            </div>
          </div>
        ...
        <div className="hidden mobile:flex flex-col h_729">
          ...
          <div className={`${s.center_bottom} bg-gray-400 relative w-100`}>
            ...
            />
            <div
              className={`${s.yellow} text-white flex flex-col absolute z-20 items-center justify-center`}
            >
              <span className={`${s.big_title} font_size_30 font-black text-white`}>
                愿景
              </span>
              <span className={`${s.big_title} font_size_24 text-white`}>
                科技重塑人生
        ...
        <div className={`hidden mobile:flex flex-col flex-1 h_729`}>
          ...
          <img
            ...
            className={`${s.right_top_img} flex-1 relative w-100 h-100 img-fluid`}
          ></img>
        </div>
      </div>
    </>
