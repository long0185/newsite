...
export const MExpercard = ({ key = null, img_src = "", name = "", sub_title = "", title = "", desc = "", date = "", view = 0 }) => {
  return (
...
const ExpertCard = ({ img_src = "", name = "", badge = "", title = "", desc = "", date = "", view = "" }) => {
  ...
  return (
    <div onClick={() => router.push("/application-detail")} className={`${s.item_2} flex justify-between items-center  mx-3`}>
      <img src={img_src} className={`${s.sm_img} relative bg-gray-400 border-2`}></img>
          ...
          <div key={index}>
            <div className="w-100 d-center">
              <div className={`${s.content_2} flex  justify-between`}>
                <ExpertCard img_src="/assets/2560/info/expert/p_1.png" name="陈武雄" badge="医学专家" desc="访谈标题访谈标题访谈标题访谈标题访谈标题" date="2021年7月23日" view="231" />
                <ExpertCard img_src="/assets/2560/info/expert/p_1.png" name="陈武雄" badge="医学专家" desc="访谈标题访谈标题访谈标题访谈标题访谈标题" date="2021年7月23日" view="231" />
              </div>
            </div>
            <div className="w-100 d-center">
