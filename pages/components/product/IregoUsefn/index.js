...
export default function index() {
  ...
  return (
    <div id="usefn" className="fun-detail flex flex-col justify-center  ">
      ...
      <div
        ref={myRef}
        className="hidden mobile:flex content items-center justify-center w-100 mb_100"
      >
        <motion.div
          variants={up_variants}
          animate={`${inViewport ? "enter_1" : "leave"}`}
          className="d-center flex-col pt-5 bg-white use-fun-item "
        >
          <div className="flex flex-col practise items-center ">
            ...
            <div className="py-3 flex justify-around w-100">
              <div className="flex items-center">
                <span className="bg-gray-200 font_size_24 text-gray-500 border-gray-500 border-2 rounded-full w-8 h-8 flex items-center justify-center mr-1">
                  1
                </span>
        ...
        <div className="flex flex-col bg-white m_use-fun-item_1 items-center justify-start">
          <div className="flex flex-col practise items-center justify-start ">
            ...
            <div className="mt_63 mb_43  flex justify-around w_582">
              <div className="flex items-center">
                <span className="bg-gray-200 font_36 text-gray-500 border-gray-500 border-2 rounded-full size_52 flex items-center justify-center mr-1">
                  1
                </span>
