...
export default function index() {
  return (
    <div
      id="interact"
      className={` bg_coffee product-interact w-100 flex flex-col align-item-center justify-center`}
    >
      ...
      <div className="p-0 flex w_1978 flex-col mobile:flex-row items-center mobile:items-start justify-between">
        <div className="flex flex-col ">
          ...
          <span className="font_size_36 h-28 text-white interact-sm-title w_910">
