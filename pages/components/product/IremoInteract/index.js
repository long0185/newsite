...
export default function index() {
  return (
    <div id="interact" className={` bg_coffee product-interact w-100 flex flex-col items-center justify-center`}>
      ...
      <div className="p-0 flex w_1978 flex-col mobile:flex-row items-center mobile:items-start justify-between">
        <div className="flex flex-col ">
          <span className="font_43 interact-big-title font-black  mb-1">医生端</span>
          <span className="font_size_24 mobile:h-28 text-white interact-sm-title ">远程训练计划的制定,查看训练报告,为医生提供更加智能化、精准化的工作平台。</span>
          <img className="interact-top-img img-fluid" src="/assets/2560/product/irego/doctor.png" />
        </div>
        <div className="flex flex-col">
          <span className="font_43 interact-big-title font-black mb-1">用户端</span>
          <span className="font_size_24 mobile:h-28 text-white interact-sm-title ">及时训,无需医生陪伴,训练中采集和存储数据,完成后自动生成报告,为患者提供更优质可靠的康复训练数据。</span>
        ...
        <div className="flex flex-col friendly-wrap">
          ...
          <div className="w-100 hidden p-0 mobile:flex justify-center">
            <div className="p-0 text-center">
              <img src="/assets/2560/product/iremo/user-friendly_1.png" className={`${s.u_img} relative`}></img>
              <span className="friendly-span block text-white mt-3">力过载保护</span>
            </div>
            <div className="p-0 text-center mx-2">
              <img src="/assets/2560/product/iremo/friend_3.png" className={`${s.u_img} relative`}></img>
              <span className="friendly-span block text-white mt-3">针对性参数设置（具有主动、被动、按需三种训练模式）</span>
            </div>
            <div className="p-0 text-center">
              <img src="/assets/2560/product/iremo/user-friendly_3.png" className={`${s.u_img} relative`}></img>
              <span className="friendly-span block text-white mt-3">多种登录方式</span>
            </div>
          </div>
