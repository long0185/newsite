    ...
    <div className={`${s.wrap} flex relative flex-col justify-between items-center bg-white `}>
      ...
      <div className={`${s.news} flex justify-center`}>
        <div className={`${s.news_1} relative cursor-pointer`}>
          <img className={`${s.news_1} img-fluid absolute `} src="/assets/2560/home/example-area.png" />
          ...
          <div className={`${s.innovate_btn} absolute  z-10`}>成功案例 · 医院</div>
        </div>
        <div className={`${s.news_1} ${s.news_mx} relative `}>
          <img className={`${s.news_1} img-fluid absolute z-10`} src="/assets/2560/home/example-personal.png" />
          <motion.div className={`${s.modal} absolute z-100 z-50 clear-both bg-$primary `} whileHover={{ opacity: 0.9 }} whileTap={{ opacity: 0 }}>
          ...
          <div className={`${s.innovate_btn} absolute z-20 `}>成功案例 · 社区</div>
        </div>
        <div className={`${s.news_1} relative`}>
          <img className={`${s.news_1} img-fluid absolute`} src="/assets/2560/home/example-his.png" />
          <motion.div className={`${s.modal} absolute z-100 z-50 clear-both bg-$primary `} whileHover={{ opacity: 0.9 }} whileTap={{ opacity: 0 }}>
