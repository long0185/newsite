    ...
    <>
      <div className='mobile:hidden flex flex-col items-center pb_104'>
        <div className='lab-title-wrap bg-white flex items-center justify-center'>
          <img className='img-fluid lab-title-img ' src='/assets/2560/Innovate/title-pro.png'></img>
        </div>
        {list.map((item, index) => (
          <div key={item.id} className={`${s.m_img_wrap} mb_43 relative border `}>
            <img src={item.img_src} className='w-100 h-100 absolute z-10' />
            <div className='w-100 h-100 opacity-01 flex justify-center items-end absolute z-20  hover:opacity-60 text-transparent hover:text-white cursor-pointer'>
              <span className=' top-8 font_size_24 bg-black  text-center py-3 w-100'>{item.desc}</span>
            </div>
          </div>
        ))}
      </div>
...
>>>>>>> 10c07ff (update)
        ...
        <div className='flex my-2 mb_175'>
          <div className={`w_857 h_567 relative mr-3  ${s.img_wrap}`}>
            <img src='/assets/2560/Innovate/project-4.png' className='w-100 h-100  absolute z-10' />
            <div className='w-100 h-100 opacity-01 flex justify-center items-end absolute z-20  hover:opacity-60 text-transparent hover:text-white cursor-pointer'>
              <span className=' top-8 bg-black  text-center py-3 w-100'>iRe+康复训练场景</span>
            </div>
          </div>
          <div className={`w_857 h_567 relative ml-3  ${s.img_wrap}`}>
            <img src='/assets/2560/Innovate/project-2.png' className='w-100 h-100  absolute z-10' />
            <div className='w-100 h-100 opacity-01 flex justify-center items-end absolute z-20  hover:opacity-60 text-transparent hover:text-white cursor-pointer'>
              <span className=' top-8 bg-black  text-center py-3 w-100'>iRe+康复训练场景</span>
            </div>
          </div>
