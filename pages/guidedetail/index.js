...
export default function index() {
  ...
  return (
    <div>
      ...
      <div
        className={`${s.m_modal} bg-$gray mobile:hidden flex flex-col items-center`}
      >
        <div
            ...
            <div className="flex items-center mr-8">
              ...
              <span>浏览:231</span>
				...
				<div className={`${s.m_btn_wrap} mt_100 flex justify-between mb_100 `}>
					<button onClick={() =>router.back()}  className={`${s.m_btn_1} text-white font_size_30  bg-$primary`}>返回列表</button>
      ...
      <div
        className={`${s.modal} border hidden mobile:flex flex-col items-center`}
      >
        <div className="z-60  bg-$color opacity-70"></div>
        <div
          className={`${s.container}  flex flex-col justify-between   opacity-100 bg-white `}
        >
          <div
            onClick={() => router.back()}
          ...
          >
            <button onClick={() =>router.back()}  className={`${s.btn} text-white h_48 w_194 mr-2  bg-$primary`}>返回列表</button>
            <button
