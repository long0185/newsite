...
var pJS = function (a, b) {
  ...
  b && Object.deepExtend(d, b),
    (d.tmp.obj = { size_value: d.particles.size.value, size_anim_speed: d.particles.size.anim.speed, move_speed: d.particles.move.speed, line_linked_distance: d.particles.line_linked.distance, line_linked_width: d.particles.line_linked.width, mode_grab_distance: d.interactivity.modes.grab.distance, mode_bubble_distance: d.interactivity.modes.bubble.distance, mode_bubble_size: d.interactivity.modes.bubble.size, mode_repulse_distance: d.interactivity.modes.repulse.distance }),
    (d.fn.retinaInit = function () {
      d.retina_detect && window.devicePixelRatio > 1 ? ((d.canvas.pxratio = window.devicePixelRatio), (d.tmp.retina = !0)) : ((d.canvas.pxratio = 1), (d.tmp.retina = !1)),
    ...
    (d.fn.particle = function (a, b, c) {
      if (((this.radius = (d.particles.size.random ? Math.random() : 1) * d.particles.size.value), d.particles.size.anim.enable && ((this.size_status = !1), (this.vs = d.particles.size.anim.speed / 100), d.particles.size.anim.sync || (this.vs = this.vs * Math.random())), (this.x = c ? c.x : Math.random() * d.canvas.w), (this.y = c ? c.y : Math.random() * d.canvas.h), this.x > d.canvas.w - 2 * this.radius ? (this.x = this.x - this.radius) : this.x < 2 * this.radius && (this.x = this.x + this.radius), this.y > d.canvas.h - 2 * this.radius ? (this.y = this.y - this.radius) : this.y < 2 * this.radius && (this.y = this.y + this.radius), d.particles.move.bounce && d.fn.vendors.checkOverlap(this, c), (this.color = {}), "object" == typeof a.value))
        ...
        } else void 0 != a.value.r && void 0 != a.value.g && void 0 != a.value.b && (this.color.rgb = { r: a.value.r, g: a.value.g, b: a.value.b }), void 0 != a.value.h && void 0 != a.value.s && void 0 != a.value.l && (this.color.hsl = { h: a.value.h, s: a.value.s, l: a.value.l });
      ...
      d.particles.move.straight ? ((this.vx = f.x), (this.vy = f.y), d.particles.move.random && ((this.vx = this.vx * Math.random()), (this.vy = this.vy * Math.random()))) : ((this.vx = f.x + Math.random() - 0.5), (this.vy = f.y + Math.random() - 0.5)), (this.vx_i = this.vx), (this.vy_i = this.vy);
      ...
      if ("image" == this.shape) {
        ...
        (this.img = { src: i.image.src, ratio: i.image.width / i.image.height }), this.img.ratio || (this.img.ratio = 1), "svg" == d.tmp.img_type && void 0 != d.tmp.source_svg && (d.fn.vendors.createSvgImg(this), d.tmp.pushing && (this.img.loaded = !1));
      }
    }),
    (d.fn.particle.prototype.draw = function () {
      ...
      switch (((d.canvas.ctx.fillStyle = f), d.canvas.ctx.beginPath(), b.shape)) {
        ...
        case "triangle":
          ...
          break;
        case "polygon":
          d.fn.vendors.drawShape(d.canvas.ctx, b.x - c / (d.particles.shape.polygon.nb_sides / 3.5), b.y - c / 0.76, (2.66 * c) / (d.particles.shape.polygon.nb_sides / 3), d.particles.shape.polygon.nb_sides, 1);
          break;
        case "star":
    ...
    (d.fn.particlesUpdate = function () {
      for (var a = 0; a < d.particles.array.length; a++) {
        ...
        else var e = { x_left: -b.radius, x_right: d.canvas.w + b.radius, y_top: -b.radius, y_bottom: d.canvas.h + b.radius };
    ...
    (d.fn.modes.pushParticles = function (a, b) {
      d.tmp.pushing = !0;
      for (var c = 0; a > c; c++) d.particles.array.push(new d.fn.particle(d.particles.color, d.particles.opacity.value, { x: b ? b.pos_x : Math.random() * d.canvas.w, y: b ? b.pos_y : Math.random() * d.canvas.h })), c == a - 1 && (d.particles.move.enable || d.fn.particlesDraw(), (d.tmp.pushing = !1));
    }),
    ...
    (d.fn.vendors.eventsListeners = function () {
      (d.interactivity.el = "window" == d.interactivity.detect_on ? window : d.canvas.el),
    ...
    (d.fn.vendors.createSvgImg = function (a) {
      var b = d.tmp.source_svg,
        c = /#([0-9A-F]{3,6})/gi,
        e = b.replace(c, function () {
          if (a.color.rgb) var b = "rgba(" + a.color.rgb.r + "," + a.color.rgb.g + "," + a.color.rgb.b + "," + a.opacity + ")";
          else var b = "hsla(" + a.color.hsl.h + "," + a.color.hsl.s + "%," + a.color.hsl.l + "%," + a.opacity + ")";
          return b;
        }),
...
$(document).ready(function () {
  if ($("#ibmcom-home").length > 0) {
    // Adding leadspace HTML to home page
    //var leadspace_html = '<div class="ibm-columns"> <div class="ibm-col-5-3 ibm-col-medium-1-1"> <h1 id="ibm-pagetitle-h1" class="ibm-h1 ibm-medium ibm-light ibm-padding-bottom-0">Smaller screens <br class="ibm-br-medium ibm-br-large ibm-br-xlarge">see bigger sales <br class="ibm-br-medium ibm-br-large ibm-br-xlarge">on Cyber Monday</h1> <p>Retail investment in responsive design <br class="ibm-br-medium ibm-br-large ibm-br-xlarge">pays off as smartphone shopping grows</p><p class="ibm-button-link ibm-padding-top-r1"> <a href="http://www.ibm.com/software/marketing-solutions/benchmark-reports/cyber-monday-2015.html?lnk=ushpv18l1" class="ibm-btn-pri ibm-btn-blue-50" style="border-color: #26aac5; background-color: #26aac5">Download the report</a> </p></div><div class="ibm-col-5-2 ibm_cci-animated-counters"> <div class="ibm-columns"> <div class="ibm-col-5-1"> <div class="ibm_cci-leadspace-data"> <p>Of all online <br class="ibm-br-large">sales<span class="ibm-hidden-large ibm-hidden-medium ibm-hidden-small"> </span></p><strong><span class="percent ibm_cci-float-counter">15.2</span><sup class="ibm-light">%</sup></strong> <p>came from smartphones</p></div></div><div class="ibm-col-5-1"> <div class="ibm_cci-leadspace-data"> <p>Of all online <br class="ibm-br-large">sales<span class="ibm-hidden-large ibm-hidden-medium ibm-hidden-small"> </span></p><strong><span class="percent ibm_cci-float-counter">12.4</span><sup class="ibm-light">%</sup></strong> <p>came from tablets</p></div></div></div><div class="ibm-columns"> <div class="ibm-col-5-1"> <div class="ibm_cci-leadspace-data"> <p>Online retail <br class="ibm-br-xlarge">sales increased</p><strong><span class="percent ibm_cci-float-counter">17.8</span><sup class="ibm-light">%</sup></strong> <p>from 2014 to 2015</p></div></div><div class="ibm-col-5-1"> <div class="ibm_cci-leadspace-data"> <p>Shoppers spent <br class="ibm-br-xlarge">an average of</p><strong><sup class="ibm-light">$</sup><span class="percent ibm_cci-number-counter">123</span></strong> <p>on each online order</p></div></div></div></div></div>';
    //$("#ibm-leadspace-body").html(leadspace_html);

    // Adding cognitive era content
    //var cognitive_html = '<div id="particles-js" class="ibm-cci_particles-background"></div><div class="ibm-columns ibm-alternate-background ibm-padding-top-r1"><div class="ibm-col-1-1 ibm-center"><h2 class="ibm-light ibm-h1">Enter the cognitive era</h2><p class="ibm-h4 ibm-regular">Find out what happens when digital intelligence <br class="ibm-br-large ibm-br-xlarge">meets digital business</p></div></div><div class="ibm-columns ibm-padding-top-r1 ibm-padding-bottom-r1 ibm-textcolor-black-core" data-widget="setsameheight" data-items=".ibm-card" data-always="true"><div class="ibm-col-6-2"><div class="ibm-card"><div class="ibm-card__image"><img class="ibm-resize" src="//www.ibm.com/us-en/images/homepage/cognitive-hp-feature-01-anthem1.jpg" width="300" height="170" alt="Hello. My name is Watson."/></div><div class="ibm-card__content"><h3 class="ibm-h3">&ldquo;Hello. My name is Watson.&rdquo;</h3><p>Designed to understand, reason and learn â€” and help us outthink our biggest challenges</p></div><div class="ibm-card__bottom"><p class="ibm-ind-link"><a class="ibm-play-link" data-widget="videoplayer" data-videodisplay="overlay" data-videoid="2h90zluU-LE" data-showvideoduration="false" data-videotype="youtube" href="https://www.youtube.com/watch?v=2h90zluU-LE&amp;amp;index=1&amp;amp;list=WL&amp;amp;lnk=ushpv18ce1" style="">See how IBM can help</a></p></div></div></div><div class="ibm-col-6-2"><div class="ibm-card"><div class="ibm-card__image"><img class="ibm-resize" src="//www.ibm.com/us-en/images/homepage/cognitive-hp-feature-watson-discovery-advisor.jpg" width="300" height="170" alt="Accelerate breakthroughs like never before"/></div><div class="ibm-card__content"><h3 class="ibm-h3">Accelerate breakthroughs like never before</h3><p>Gain fresh insights when you connect data in new way</p></div><div class="ibm-card__bottom"><p class="ibm-ind-link"><a class="ibm-forward-link" href="http://www.ibm.com/smarterplanet/us/en/ibmwatson/discovery-advisor.html?lnk=ushpv18ce2">Explore Watson Discovery Advisor</a></p></div></div></div><div class="ibm-col-6-2"><div class="ibm-card"><div class="ibm-card__image"><img class="ibm-resize" src="http://www.ibm.com/us-en/images/homepage/cognitive-03.jpg" width="300" height="170" alt="Cognitive apps, built by Watson"/></div><div class="ibm-card__content"><h3 class="ibm-h3">Cognitive apps, built by Watson</h3><p>Our developer cloud is filled with code and docs</p></div><div class="ibm-card__bottom"><p class="ibm-ind-link"><a class="ibm-forward-link" href="http://www.ibm.com/smarterplanet/us/en/ibmwatson/developercloud/gallery.html?lnk=ushpv18ce3">Interact with Watson in the App Gallery</a></p></div></div></div></div><div class="ibm-columns ibm-alternate-background ibm-padding-bottom-r2"><div class="ibm-col-1-1 ibm-center"><p><a href="http://www.ibm.com/cognitive/?lnk=ushpv18ce4" class="ibm-btn-pri ibm-btn-white-30">See more cognitive content</a></p></div></div>';
    //$("#ibmcom-home").append(cognitive_html);

    // Adding band backgroung animation
    homeAnimation();

    // Home page percent animation
    $("span.ibm_cci-float-counter").each(function () {
      var b = $(this);
      $({
        someValue: 0.1,
      }).animate(
        ...
        },
        {
          ...
          easing: "swing",
          step: function () {
            b.text(this.someValue.toFixed(1));
          },
        }
      );
    });
    ...
    // Home page percent animation
    $("span.ibm_cci-number-counter").each(function () {
      var b = $(this);
      $({ someValue: 1 }).animate(
        { someValue: b.text() },
        {
          ...
          easing: "swing",
          step: function () {
            b.text(Math.round(this.someValue));
          },
        }
      );
    });
